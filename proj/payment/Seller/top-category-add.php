...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("INSERT INTO tbl_top_category (tcat_name, show_on_menu) VALUES (:tcat_name, :show_on_menu)");
    $statement->execute([':tcat_name' => $_POST['tcat_name'], ':show_on_menu' => $_POST['show_on_menu']]);
