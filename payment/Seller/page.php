                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                        <?php echo htmlspecialchars(isset($about_title) ? $about_title : ''); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Page Content * </label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="about_content" id="editor1"><?php echo htmlspecialchars(isset($about_content) ? $about_content : ''); ?></textarea>                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                        <?php echo htmlspecialchars(isset($about_meta_title) ? $about_meta_title : ''); ?>                                        </div>
                                    </div>             
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Keyword </label>
                                        <div class="col-sm-8">
                                        <?php echo htmlspecialchars(isset($about_meta_keyword) ? $about_meta_keyword : ''); ?>                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Description </label>
                                        <div class="col-sm-8">
                                        <?php echo htmlspecialchars(isset($about_meta_description) ? $about_meta_description : ''); ?>                                        </div>
                                    </div>                                    
                                    <div class="form-group">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Page Title * </label>
                                        <div class="col-sm-5">
                                        <?php echo htmlspecialchars(isset($faq_title) ? $faq_title : ''); ?>                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Existing Banner Photo</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Title</label>
                                        <div class="col-sm-8">
                                        <?php echo htmlspecialchars(isset($faq_meta_title) ? $faq_meta_title : ''); ?>
                                        </div>
                                    </div>             
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Keyword </label>
                                        <div class="col-sm-8">
                                        <?php echo htmlspecialchars(isset($faq_meta_keyword) ? $faq_meta_keyword : ''); ?>                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Description </label>
                                        <div class="col-sm-8">
                                        <?php echo htmlspecialchars(isset($faq_meta_description) ? $faq_meta_description : ''); ?>                                        </div>
                                    </div>                                    
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Page Title * </label>
                                        <div class="col-sm-5">
                                        <?php echo htmlspecialchars(isset($contact_title) ? $contact_title : ''); ?>                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Existing Banner Photo</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Title</label>
                                        <div class="col-sm-8">
                                        <?php echo htmlspecialchars(isset($contact_meta_title) ? $contact_meta_title : ''); ?>                                        </div>
                                    </div>             
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Keyword </label>
                                        <div class="col-sm-8">
                                        <?php echo htmlspecialchars(isset($contact_meta_keyword) ? $contact_meta_keyword : ''); ?>                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Description </label>
                                        <div class="col-sm-8">
                                        <?php echo htmlspecialchars(isset($contact_meta_description) ? $contact_meta_description : ''); ?>                                        </div>
                                    </div>                                    
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
